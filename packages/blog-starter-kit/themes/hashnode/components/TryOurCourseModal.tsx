  ...
  return (
    <div className="inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-96">
        <h2 className="text-lg font-bold mb-4">Try Our Course for 1 day @29</h2>
        <p className="mb-6">Try our course for 1 day and if you like it, you can go for one year or lifetime access! </p>
